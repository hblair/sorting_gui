...
class Application(Frame):
    ...
    def create_widgets(self):
        ...
        #Here I will set up the submit buttons
        ...
        #Here I will set up the output box and subsequent scroll script
    ...
    #Now we're gonna do the function definitions!
    ...
    def sendNucData(self):
        ...
        #userInput = ided.datExp(True,True,elementName = self.chemSymVar, lowerBound = self.lowBoundIsoVar, higherBound = self.upBoundIsoVar, wantedSpins = self.spinVar, energyLim = self.upBoundEnergyVar)
...
class guioutputs_Hayden:      
    ensdfprefix=str('ensdf.')

#Variables for Peter's part
    Z=app.chemSymVar
